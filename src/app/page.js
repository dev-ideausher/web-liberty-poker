...
export default function Home() {
  return (
    <div className="h-screen w-full flex flex-col justify-between items-center">
      <img src="/images/banners/landing.png" alt="bba" className="h-screen absolute w-full" />
      <HomeHeader/>
      <div className="h-full z-20 w-full flex flex-col justify-end items-center pb-10">
        ...
        <Link href="/sit"><Button variant="primary" className="w-fit px-6 py-3.5 text-primary-props border-8 rounded-[29px]">PLAY NOW</Button></Link>
        <HomeOptions />
      </div>
    </div>
  );
