  ...
  return (
    <div className="min-h-screen h-full w-full flex bg-fixed bg-[url('/images/banners/banner-sit.png')] flex-col items-center bg-cover bg-center">
        <div className="h-full z-20 layout-container pb-5 flex flex-col items-center">
          ...
          <Link href="/choose-rank" className="bg-[url('/images/chip.svg')] bg-cover flex items-center justify-center w-[380px] h-72">
              <p className='text-[40px] w-full font-cinzel font-black text-center leading-none -mt-0'>CREATE<br/> TABLE</p>
          </Link>
          <HomeOptions/>
        </div>
    </div>
