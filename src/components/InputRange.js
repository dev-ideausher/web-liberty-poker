    ...
    return (
        <>
            <div className='w-full flex gap-5 justify-between items-center mt-4'>
                <div>
                    <Button variant="primary" className="border border-primary" onClick={decrementHandler} className="p-1">
                ...
                <div>
                    <Button variant="primary" className="border border-primary" onClick={incrementHandler} className="p-1">
                        <svg className='scale-75' xmlns="http://www.w3.org/2000/svg" width="32" height="33" viewBox="0 0 32 33" fill="none">
