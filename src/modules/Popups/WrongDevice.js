...
export default function WrongDeviceModal({exitHandler}) {
    return (
        <div className='popup-container'>
            <div className='popup w-2/3 p-12 flex flex-col items-center'>
                ...
                <h1 className='text-[64px] font-normal font-ruso normal-text-shadow text-center'>WRONG DEVICE </h1>
                <h3 className='text-[32px] font-normal normal-text-shadow text-center '>Either change the wallet you use on the second account or open a new account using this wallet.</h3>
