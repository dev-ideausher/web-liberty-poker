...
export default function WrongWalletModal({exitHandler}) {
    return (
        <div className='popup-container'>
            <div className='popup w-2/3 p-12 flex flex-col items-center'>
                ...
                <h1 className='text-[64px] font-normal font-ruso normal-text-shadow text-center'>WRONG WALLET </h1>
                <h3 className='text-[32px] font-normal normal-text-shadow text-center '>You connected a wallet which is already used in a different platform. To continue, please ...</h3>
